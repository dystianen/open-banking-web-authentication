...
import { Button, Card, Carousel, Col, Form, Image, Input, Row, Typography } from "antd";
import { ArrowLeftOutlined, CloseOutlined, QuestionCircleOutlined } from "@ant-design/icons";
import LogoBNI from '../../assets/logo/BNI.png';
import Trustlink from '../../assets/logo/trustlink.png';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft, faShield, faXmark } from "@fortawesome/free-solid-svg-icons";
            ...
            <Card style={styles.card}>
                <div style={styles.container}>
                    ...
                    <div style={styles.logo}>
                        ...
                        <Title level={5} style={{ marginTop: '20px' }} strong>Insert your credentials to start.</Title>
                    </div>
                    ...
                    <Form layout={'vertical'}>
                        ...
                        <Button style={{ backgroundColor: '#93969B', color: '#FFFFFF' }} block size='large'>Connect
                            Account</Button>
                    </Form>

                    <div style={{ marginTop: '50px' }}>
                        <Title level={5}>Need a guide?</Title>
                        <Carousel infinite={false} style={styles.carousel}>
                            <div>
                                <Row>
                                    <Col span={2}>
